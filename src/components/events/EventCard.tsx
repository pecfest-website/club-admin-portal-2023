...
import { Accordion, AccordionDetails, AccordionSummary, Button, Card, CardActions, CardContent, CardHeader, CardMedia, Dialog, DialogContent, DialogTitle, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Tooltip, Typography } from '@mui/material';
import { useRouter } from 'next/router';
import React, { useState } from 'react'
import * as XLSX from 'xlsx';

const EventCard = ({ id, image, event_name, event_id, token, type }: any) => {
                      ...
                      <AccordionDetails>
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                          ...
                          <TableBody>
                            {user.members &&
                              user.members.length &&
                              user.members.map((member: any, id: any) => (
                                <TableRow
                                  key={id}
                                  sx={{
